...
% Exact solution of the diamond test case
...
%% plot
figure;
plot(x,M,'--k','linew',1.5);

hold on;
plot(T1.Points_0,T1.Mach,'r','linew',1.5);
%plot(T2.Points_0,T2.Mach,'b','linew',1.5);
%plot(T3.Points_0,T3.Mach,'k','linew',1.5);
